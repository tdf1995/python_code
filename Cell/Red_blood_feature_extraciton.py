                ...
                for i in range(len(contours)):
                    ...
                    if 8000 < area < 25000:
                        ...
                        if ((area < 18000 and dConvexity > 0.9) or dConvexity > 0.95):
                            ...
                            features = np.append([aspectio,circularity,dConvexity,defects_num,equi_radius,smoothness,
                            ...
                            saved_labels.append(float(dirname))
pickle.dump(saved_features, open(r'E:\细胞\hongxibao\混合/features.pkl', 'wb'))
pickle.dump(saved_labels, open(r'E:\细胞\hongxibao\混合/labels.pkl', 'wb'))